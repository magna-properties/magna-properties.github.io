...
function showTypeformBanner(){
  ...
  banner.innerHTML='<div class="cookie-banner-copy"><h2 id="cookie-banner-title" data-pt="Cookies do formulário" data-en="Form cookies">Cookies do formulário</h2><p data-pt="O formulário Typeform utiliza cookies funcionais e pode utilizar cookies analíticos e de publicidade/perfil. Só o carregamos se autorizar." data-en="The Typeform form uses functional cookies and may use analytics and advertising/profiling cookies. We only load it with your permission.">O formulário Typeform utiliza cookies funcionais e pode utilizar cookies analíticos e de publicidade/perfil. Só o carregamos se autorizar.</p><a href="../politica-de-cookies.html" data-pt="Saber mais" data-en="Learn more">Saber mais</a></div><div class="cookie-banner-actions"><button class="btn btn-ghost" type="button" data-cookie-reject data-pt="Recusar" data-en="Reject">Recusar</button><button class="btn btn-primary" type="button" data-cookie-accept data-pt="Aceitar Typeform" data-en="Accept Typeform">Aceitar Typeform</button></div>';
